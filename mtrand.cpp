 ...
 void 
 MTRand_int32::gen_state() { // generate new state vector
 ...
 void 
 MTRand_int32::seed(unsigned long s) {  // init by 32 bit seed
 ...
 void 
 MTRand_int32::seed(const unsigned long* array, int size) { // init by array
	seed(19650218UL);
	int i = 1, j = 0;
